...
//   const handleSubmit = async (e) => {
//     e.preventDefault();
//     const action = await dispatch(updateUser({ id: user.id, data: formData }));
...
//           Save
//         </button>
//         <button type='button' onClick={()=>navigate(-1)} className='bg-gray-500 font-bold rounded-md hover:bg-gray-600 text-white px-4 py-2'>Cancel</button>
//         </div>
//       </form>
//     </div>
//   );
